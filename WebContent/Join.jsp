		...
		<div class="container">
			<div class="row">
				<div class="col-xl-9 mx-auto">
					<h2 class="mb-5 mx-auto mb-5 mb-lg-0 mb-lg-3">회원가입</h2>
					<br /> <br />
				...
				<form action="main.do" method="post">
					...
					<div class="form-row" style="margin: 0 0 20px 0;">
						...
						<div class="col">
							<input type="date" class="form-control form-control-lg"
								placeholder="이름을 입력하세요" style="width: 200px; margin: 0 10 0 50;" name="ubirth">
						</div>
					</div>
					<div class="form-row" style="margin: 0 0 10px 0;">
						<div class="col" class="form-control form-control-lg"
					...
					<div class="form-row" style="margin: 20px 15px 50px 35px;">
						<div class="col">
							<input type="submit" class="btn btn-block btn-lg btn-primary" value="가입하기">
							<br /> <br /> <br />
						</div>
					</div>
